...
start = time.perf_counter()
swt = sw.Simulation(num_agents=agent, num_steps=steps, dynamic_percent=0.5, random_seed=0)
sw_exe = time.perf_counter() - start
print('without awm', sw_exe)

start = time.perf_counter()
ut = ut.Simulation(num_agents=agent, num_steps=steps, dynamic_percent=0.5, random_seed=0)
ut_exe = time.perf_counter() - start
print('untitled', ut_exe)
...
sw_res = swt.return_results_as_df()
print('sw_res', sw_res)
